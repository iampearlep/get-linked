        ...
        <div className="px-10 hidden md:block">
          <div className="py-10 w-full flex justify-center items-center">
            <div className="max-w-7xl mx-auto w-full grid grid-cols-9">
              ...
              <div className="col-span-4 w-full h-full flex justify-start items-center">
                <div className="text-[#d434fe] font-semibold px-4">
                  <p>November 18, 2023</p>
                </div>
              </div>
              {/* stack 2 */}
              <div className="col-span-4 w-full h-full flex justify-end items-center">
                <div className="text-[#d434fe] font-semibold px-5">
                  <p>November 18, 2023</p>
                </div>
              </div>
              <div className="relative col-span-1 w-full h-full flex justify-center items-center">
